...
**Ran the app in production (powershuffle.ianblanc.com) for 1+ year before retiring hosting in 2025 due to AWS's shift to a credit-based free tier and Spotify's tightened API terms**
